...
function generateAvatarUrl(firstName, lastName) {
    ...
    // Construct the URL
    const url = `https://ui-avatars.com/api/?color=${textColor}&background=${bgColor}&name=${firstName}+${lastName}&size=150&font-size=0.25`;
    return url;
}
exports.default = generateAvatarUrl;
